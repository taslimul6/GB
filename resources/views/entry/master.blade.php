            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href={{route('en.logout')}} class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('en.prD')}}"><i class="fa fa-circle-o"></i>Departmental Report </a></li>
            <li><a href="{{route('en.prA')}}"><i class="fa fa-circle-o"></i>Advance Payment Report</a></li>
          </ul>
        </li>
