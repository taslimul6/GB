            ...
            <div class="row">
                <div class="col-md-12" style="padding: 0 !important;">
                    ...
                    <div class="box box-primary">
                      ...
                      <form role="form" method="post"  action="{{route('en.payment.store')}}">
                        @csrf
                  ...
                  <div class="box">
                    ...
                    <div class="box-body table-responsive no-padding">
                      <table class="table table-hover">
                        ...
                        <tr>
                          <td @if ($pay->id == $last->id)  data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$sumk = $i++}}</td>
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->created_at}}</td>
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->session->title}}</td>
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->semester_id}}</td>
                          <td @if ($pay->id == $last->id)  data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->details}}
                          ...
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->debit}}</td>
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->credit}}</td>
                          <td @if ($pay->id == $last->id) data-toggle="modal" data-target="#modal-{{$pay->id}}" @endif>{{$pay->balance}}</td>
                          <td>
                            @if ($pay->id == $last->id)
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-footer">
                                    ...
                                    <form action="{{route('en.payment.destroy' , $pay->id)}}" method="post">
                                      @csrf
                                      @method('delete')
                                      <input name="student_id" type="hidden" class="form-control" value="{{$data->student_id}}">
                        ...
                        <div class="modal fade" id="modal-{{$pay->id}}">
                          <div class="modal-dialog">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                <form role="form" method="post"  action="{{route('en.payment.update' , $pay->id)}}">
                                  @csrf
                                  @method('put')
                                  <div class="box-body">
                                      <input name="student_id" type="hidden" class="form-control" value="{{$data->student_id}}">
