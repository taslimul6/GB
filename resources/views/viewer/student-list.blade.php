        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              ...
              <div class="box-tools">
                  <form action="{{route('vw.stu.list')}}" mathod='get'>
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover">
                ...
                <tr>
                  ...
                  <td><a href="{{route('vw.stu.show', $data->id)}}">{{ $data->full_name }}</a></td>
                  <td>{{ $data->blood }}</td>
                  <td>{{ $data->phone }}</td>
                  <td><a  class="btn btn-primary" href="{{ route('vw.stu.edit' , $data->id)}}">Edit</a></td>
                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-footer">
                          ...
                          <form action="{{ route('vw.stu.destroy' , $data->id)}}" method= "post">
                            @csrf
                            @method('delete')
