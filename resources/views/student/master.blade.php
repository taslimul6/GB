...
<div class="wrapper">
  ...
  <header class="main-header">
    <!-- Logo -->
    <a href="{{route('st.index')}}" class="logo">
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
               ...
               <h4 style="color:white"> Student ID: {{auth()->user()->student_id}}</h4>
              </li>
              <!-- Menu Body -->
              ...
              <li class="user-footer">
                ...
                <div class="pull-right">
                  <a href="{{route('st.logout')}}" class="btn btn-default btn-flat">Sign out</a>
                </div>
              </li>
            </ul>
          </li>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{route('payment.online')}}"><i class="fa fa-circle-o"></i>Pay Online </a></li>
            <li><a href="{{route('st.Onlog')}}"><i class="fa fa-circle-o"></i>Online Payment History</a></li>
          </ul>
        </li>
        
        <li >
          <a href="{{route('st.payment')}}">
