...
class OfficerPageController extends Controller
{
    ...
    { 
        ...
        return view('officer.index' , compact('all' , 'pays' , 'deps' , 'tst' , 'ats','opays'));
    ...
    public function pCreate()
    {
        if(request('student_id')){
            ...
            return view('officer.payment-entry' , [
                'data' => $user,
                'sems' => $sems,
                'sess' => $sess,
                'pays' => $pays,
    ...
    public function plog(){
        ...
        return view('officer.payment-log' , [
    ...
    { 
        ...
        if(request('next')==1){
            ...
            return view('officer.payment-due' , compact('all' , 'department_id' , 'sess' , 'session_id' ,'status' ));

        }
     
        else{
            return view('officer.payment-due' , compact('all' , 'department_id' , 'sess' , 'session_id' ));
        }
    ...
    { 
        if(request('payslip')){
            ...
            return view('officer.pr-advance' , [
    ...
    public function wait(){
        ...
        $datas = Onlinepayment::where('state' , '=' , '1')->get()->all();
         ...
         return view('officer.online-wait' , compact('datas'));
     } 
     ...
     public function Olog(){
         ...
         ->orWhere('state' , '=' , '3')->orderby('created_at', 'desc')->get()->all();
          ...
          return view('officer.online-log' , compact('datas'));
      } 
     ...
     public function Odelete($id){
      ...
      public function Oprocess($id){
         ...
         return view('officer.online-edit' , compact(  'sess' ,'data'));
     }
